...
<body>
    ...
    //-->
        ...
        <div data-role="content" role="main">
            ...
            <div class="content-primary">
                <ul data-role="listview" data-inset="true" data-theme="c">
                    <%--               <li data-role="divider" role="heading" class="ui-bar-f">Music Import
                    </li>
                    <li>
                        <div id="toggleholder"></div>
                        <div data-role="fieldcontain">
                            <ul data-role="listview" id="holderlist" data-inset="true" data-theme="c">
                                <li>
                                    <div id="holder" style="width: 100%; height: 70px; border: dashed;">Drop here.</div>
                                </li>
                                <li>
                                    <div data-role="controlgroup" data-type="horizontal">
                                        <a href="#" data-role="button" id="prev_measure_score">Previous</a>
                                        <a href="#" data-role="button" id="next_measure_score">Next</a>
                                        <!--<a href="#" data-role="button" id="setbasebtn">Set Base</a>-->
                                    </div>
                                    <div id="curentpage_score"></div>
                                </li>
                                <li>
                                    <canvas id="scorediv" class="scorediv"></canvas>
                                </li>
                            </ul>
                        </div>
                    </li>--%>
